...
#ifndef _core_library_ConstF_h
#define _core_library_ConstF_h
...
namespace core_library
{
    ...
    /**
       Const Basic Function. Derive from this class when defining
    ...
    **/
    template <class R>
    class ConstF : public FunctorBase
    {
    public :
    ...
    */
    template<class R>
    FunctorBase::procedure_tag functor_category(const ConstF<R>&)
    {
	return FunctorBase::procedure_tag();
    }
