...
#ifndef _core_library_TF_h
#define _core_library_TF_h
...
namespace core_library
{
    ...
    /**
       Basic Tertiary Functor. Derive from this class when defining
    ...
    */
    ...
    FunctorBase::tertiary_function_tag functor_category(const TF<A1, A2, A3, R>&)
    {
	return FunctorBase::tertiary_function_tag();
    }
