...
namespace core_library
{
    ...
    ParserLogger::ParserLogger(unsigned _argc, char** _argv,
			       std::string _programDescription /*= ""*/,
			       std::string _lFileParamName /*= "param-file"*/,
			       char _shortHand /*= 'p'*/)
	: Parser(_argc, _argv, _programDescription, _lFileParamName, _shortHand),
    ...
    {
	//------------------------------------------------------------------
	// we are saying to Parser to create the parameters created above.
	//------------------------------------------------------------------
