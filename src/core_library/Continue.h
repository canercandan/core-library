...
#ifndef _core_library_Continue_h
#define _core_library_Continue_h
...
namespace core_library
{
    ...
    /** Termination condition for an algorithm
     * Takes a value as input, returns true for continue,
     ...
     */
    template< class Atom >
    class Continue : public UF<const Atom&, bool>, public Persistent
    {
    public:
